...
public abstract class BaseprofilerResourceImpl implements profilerResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/profiler/v1.0/profiler/agent/add'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "We need a query/agent within the payload from objects"
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "profiler")}
	)
	@javax.ws.rs.Path("/profiler/agent/add")
	@javax.ws.rs.POST
	@Override
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseprofilerResourceImpl.class);
